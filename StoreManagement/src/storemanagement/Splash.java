...
public class Splash extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Myprogress.setBackground(new java.awt.Color(101, 109, 74));

        jLabel1.setFont(new java.awt.Font("SansSerif", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(127, 85, 57));
        jLabel1.setText("Managing Center");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/storemanagement/1.png"))); // NOI18N
        jLabel2.setMaximumSize(new java.awt.Dimension(275, 256));
        jLabel2.setMinimumSize(new java.awt.Dimension(275, 256));
        jLabel2.setPreferredSize(new java.awt.Dimension(550, 512));
    ...
    public static void main(String args[]) { //Loading Mpara klp
